              ...
              <header className="flex-none h-12 border-b border-border bg-background px-3 flex items-center gap-3 z-50 sticky top-0">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="flex flex-col leading-none">
                    <span className="font-bold text-sm font-display tracking-tight" data-testid="text-header-app-name">DocuMind</span>
                    <span className="text-[10px] text-muted-foreground hidden sm:inline leading-tight mt-0.5">Document inference & knowledge chat</span>
                  </div>
                </div>
              </header>
