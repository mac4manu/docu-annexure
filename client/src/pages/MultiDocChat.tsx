          ...
          messages.map((msg, i) => (
            ...
            >
              ...
              <div className="flex flex-col gap-1 max-w-[80%]">
                <div className={`rounded-2xl p-3 text-[13px] leading-relaxed ${msg.role === "user" ? "bg-primary text-primary-foreground rounded-br-none" : "bg-card border border-border/50 rounded-bl-none text-foreground"}`}>
                  {msg.role === "assistant" ? (
