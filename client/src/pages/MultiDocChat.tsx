  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <Sheet open={showHistory} onOpenChange={setShowHistory}>
        <SheetContent side="right" className="w-80 sm:w-96 sm:max-w-md p-0 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-2">
            {convsLoading ? (
              ...
              <div className="space-y-0.5">
                {historyConversations.map(conv => (
                  <div
                    ...
                    className={`flex items-center gap-2.5 px-3 py-2.5 rounded-md cursor-pointer text-sm group ${conversationId === conv.id ? "bg-primary/10 border border-primary/20" : "hover-elevate"}`}
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-xs text-muted-foreground/60 mt-0.5">Your conversations will appear here</p>
              </div>
            )}
          </div>
        </SheetContent>
